...
ฑฑบPrograma  ณMATA972   บAutor  ณAndreia do Santos   ?Data ? 16/06/00    บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออออออนฑฑ
ฑฑบDesc.     ณGIA Eletronica - Valida para a Secretaria da Fazenda do Es-  บฑ?
ฑฑ?         ณtado de Sao Paulo vigorando a partir da referencia julho/2000บฑ?
ฑฑ?         ณa Nova GIA, contem em um unico documento as informacoes eco- บฑ?
ฑฑ?         ณnomico-fiscais de 5 documentos em 1: GIA, GIA-ST-11, GINTER, บฑ?
ฑฑ?         ณZona Franca Manaus/ALC e DIPAM-B. Portaria CAT 46/2000.      บฑ?
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao	 ณa972ProcessaบAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ?Faz o processamento de forma a montar os arquivos temporariosบฑ?
ฑฑ?         ณpara gerar gerar o arquivo texto final.                     	บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?MATA972                                                    	บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
Local lRet  := .F.
Local nX    := 0
Local lAglFil  := (mv_par22 == 1)   // A Variแvel ?local para ser passada por parโmetro na fun็ใo a972MontTrab, que ?chamada por outras rotinas.
...
ณParametros															    ?
ณmv_par01 - Data Inicial       ?     									?
ณmv_par02 - Data Final         ?   										?
ณmv_par03 - Tipo de GIA        ? (01-Normal/02-Substitutiva)			?
ณmv_par04 - GIA com Movimento  ? (Sim/Nao)								?
ณmv_par05 - GIA ja transmitida ? (Sim/Nao)								?
ณmv_par06 - Saldo Credor - ST  ?    									?
ณmv_par07 - Regime Tributario  ? (01-RPA/02-RES/03-RPA-DISPENSADO)     	?
ณmv_par08 - Mes de Referencia  ?      									?
ณmv_par09 - Ano de Referencia  ?      									?
ณmv_par10 - Mes Ref. Inicial   ?      									?
ณmv_par11 - Ano Ref. Inicial   ?      									?
ณmv_par12 - Livro Selecionado  ?      									?
ณmv_par13 - ICMS Fixado para o periodo?									?
ณmv_par14 - Nome do arquivo    ?										?
ณmv_par15 - Versใo do Validador?										?
ณmv_par16 - Versใo do Layout   ?    									?
ณmv_par17 - Drive Destino                                               ?
ณmv_par18 - Filial De                                                   ?
ณmv_par19 - Filial Ate                                                  ?
ณmv_par20 - NF Transf. Filiais                                          ?
ณmv_par21 - Seleciona Filiais?                                          ?
ณmv_par22 - Aglutina por CNPJ?                                          ?
ณmv_par23 - Gerar o registro CR=26 ?                                    ?
ณmv_par24 - Gerar o registro CR=27 ?                                    ?
...
ฑฑษออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunctionณA972MontTrabบAutor  ณAndreia dos Santos  ?Data ? 25/07/00   บฑ?
ฑฑฬออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.   ณArmazena as informacoes nos arquivos temporarios para depois  บฑ?
ฑฑ?       ณgerar arquivo texto.                                          บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso     ?MATA972                                                      บฑ?
ฑฑศออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
//ณVerifica como as filiais serao processadas:?
//? apenas a filial                          ?
//? filial de/ate                            ?
...
While !SM0->(Eof ()) .And. FWGrpCompany() == cEmpAnt .And. (SM0->M0_CODFIL<=cFilAte)
	...
	//ณSe foram selecionadas as filiais, identifica se a filial posicionada esta selecionada no array?
...
For n0 := 1 to Len(aSM0)
	...
	//ณCabecalho do documento Fiscal - CR=05 ?
	...
	#IFDEF TOP
		If TcSrvType() <> "AS/400"
			...
			If !lRelDIPAM .and. !lTms
				//Se nใo for relat๓rio da Dipam, os campos serใo tratados de forma agrupada
			...
			Else
				//Se relat๓rio da dipam entใo os campos nใo serใo tratados de forma agrupada.
	...
	While (cAliasSF3)->(!Eof()) .and. xFilial("SF3")==(cAliasSF3)->F3_FILIAL
		...
		*/
		...
		If ((cAliasSF3)->F3_TIPO=="S" ) .OR. (cCfop3 $"000#999") .Or. (cCfop4 $"1601#1602#1605#5601#5602#5605")
			...
			//ณGrava arquivo temporario CR=25 (cArqIE)?
		...
		If	lGerCR26 .And. (cCfop4 $"5603#6603") //NOTA FISCAL DE RESSARCIMENTO
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
			//ณGrava arquivo temporario CR=26 (cArqIeST)?
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
			If !lRelDIPAM
		...
		If	lGerCR27 .And. (cCfop4 $"1603#2603") //NOTA FISCAL DE RESSARCIMENTO
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
			//ณGrava arquivo temporario CR=27 (cArqIeSD)?
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
			If !lRelDIPAM
		...
		If !lRelDIPAM
			...
			//ณTratamento para PIS/COFINS agregado no total da Nota     ?
			...
			//Para ambiente TOP o tratamento deste trecho ?feito logo ap๓s o final da query principal
			//pois este la็o da SF3 em ambiente TOP ?de maneira agrupada, e desta manera nใo temos como chegar no nํvel de item
			//esta altera็ใo foi devida altera็ใo de melhoria de performance.
			IF !lTop
				If cTipoNf="E"
			...
			If !lRelDIPAM .And. nRegime <> 4
				...
				//ณDetalhes Interestaduais CR=14?
				...
				If (cCfop1$"26" .and. cMvUF <> "SP") .or. (cCfop1$"26" .and. !(cUF$cCodUf) .and. cMvUF == "SP")
					...
					//ณZona Franca de Manaus /Areas de Livre Comercio CR=18?
					//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
					//Tratamento em DBF para gera็ใo do Registro CR=18. O tratamento em ambiente TOP ser?tratado posteriormente
					//devido uma altera็ใo de melhoria de processamento, pois quando o processamento ?e top,
					//o loop da SF3 ?feito de forma agrupada, e como este registro necessito de informa็๕es no nํvel
					...
					If !lTop .AND. cCfop1=="6" .and. (cAliasSF3)->F3_ESTADO $ "AC/AP/AM/RO/RR/" .and. (cAliasSF3)->F3_ISENICM > 0
						...
						If lZFranca
							...
							//ณIndica no Registro Detalhes Interestaduais que existe?
							//ณoperacoes beneficiadas por Isencao do ICMS.          ?
		...
		If lRelDIPAM .OR. nRegime <> 4
					...
					Case ( (nAno<2003 .And. cCfop3$"561/562/563/661/662/663/761") .Or. (nAno>=2003 .And. cCfop4$"5351/5352/5353/5354/5355/5356/5357/5358/5359/5360/6351/6352/6353/6354/6355/6356/6357/6358/6359/6360/7358" .Or. (cCfop4$"1351/2351/3355" .and. !lRelDIPAM)))
						If ( (cAliasSF3)->F3_BASEICM + (cAliasSF3)->F3_ISENICM + (cAliasSF3)->F3_OUTRICM > 0 )
							...
							If !lRelDIPAM
								...
								Sera ignorada todas as notas de saํda que ponto de entrada altere valor para 1.

								Quando ponto de entrada retornar todas as saํdas de determinado municํpio que se enquadre nas regras dos registros 2.3,2.4 e 2.5, registro ser?preenchido com valor um real (R$ 1,00) no arquivo da Nova Gia na CR30.
								*/
								If n23ent > 0
									VALORENT += n23ent
								Else
									If lMA972VLR
										...
										If nValor == 1
											aadd(aDipamB23,{'23',cCodMunDp}) /*adiciono array para verificar no fim das notas se este 
																			municipio nใo possui outras saidas que ponto nใo alterou*/
										Else
											VALOR += n23sai  // somente ?somavo valor no cArqDipam quando ponto nใo alterou seu valor para 1.
										Endif
									Else
										VALOR += n23sai
									Endif
							...
							If lMA972VLR
								...
								If nValor == 1
									aadd(aDipamB25,{'25',cCodMunDp})/*adiciono array para verificar no fim das notas se este
																	municipio nใo possui outras saidas que ponto nใo alterou*/
								Else // somente ?somavo valor no cArqDipam quando ponto nใo alterou seu valor para 1.
									VALOR += n25Sai
								Endif
							Else
								VALOR += n25Sai
			...
			//ณReg Exportacao CR=31?
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			//Aqui serใo tratados opera็๕es de exporta็๕es caso o ambiene seja DBF, caso for TOP, ser?tratado em uma query separada,
				...
				If lGeraExp
					If SD2->(msseek(xFilial("SD2")+(cAliasSF3)->F3_NFISCAL+(cAliasSF3)->F3_SERIE))
						While SD2->(!Eof()) .and. (cAliasSF3)->F3_NFISCAL+(cAliasSF3)->F3_SERIE == SD2->D2_DOC+SD2->D2_SERIE .and.;
							...
							dbSetOrder(1)
							nT  		:= 0
							//Se tiver integra็ใo para com EEC e o campo nao estiver criado, emitir aviso e retornar.
							If SD2->(FieldPos(cD2_Re))==0 .and. SuperGetMV("MV_EECFAT")
								Aviso("Integra็ใo com o m๓dulo SIGAEEC Habilitada ","Por favor crie o campo " + cD2_Re + " via configurador.",{"Ok"}) //Nใo foi possivel excluir a nota, pois a mesma j?foi transmitida e encotra-se bloqueada. Ser?necessแrio realizar a primeiro a classifica็ใo da nota e posteriormente a exclusใo!"
								return
							EndIf
			...
			Elseif !lTop  .AND. !lRelDIPAM .And. !lD2_Re
				...
				If lGeraExp
					If SD2->(msseek(xFilial("SD2")+(cAliasSF3)->F3_NFISCAL+(cAliasSF3)->F3_SERIE))
						...
						//ณProcessamento da funcao da Average que retorna os avisos de embarque conforme regras do SIGAEEC ?
						//|Conforme solicitado nos Chamados: THMQEB e THMOIB, he necessแrio as datas de RE e DSE para o R31|
	...
	//ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//Tratar aqui ZF e Exporta็ใo
	//ฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ

	//este trecho do zona franca ?realizado aqui fora do loop da SF3, pois trata de informa็ใo a nํvel de documento
		...
		For nX := 1 to len(aApuICM)
			...
			If alltrim(aApuICM[nX][1])$"002#003#006#007#012" .and. aApuICM[nX][3] > 0
				...
				If !(cSubCod$"00200#00300#00600#00700#01200")
					...
					Else
						//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
						//ณCaso existam codigos duplicados na apuracao, ira criar apenas uma linha?
						//ณno CR=20, acumulando os valores.                                       ?
						//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
...
If !lRelDIPAM
	...
	If (cArqDipam)->(msseek("23"))
		While !((cArqDipam)->(Eof())) .and. (cArqDipam)->CODDIP=="23"
			...
			Endif
			RecLock(cArqDipam,.F.)
			If !lAchou23  // caso nใo encontre altera็๕es do PE, mantem valor gravado no temporario.
				if  (VALOR - VALORENT) > 0
	...
	If (cArqDipam)->(msseek("24"))
		While !((cArqDipam)->(Eof())) .and. (cArqDipam)->CODDIP=="24"
			...
			Endif
			RecLock(cArqDipam,.F.)
			If !lAchou24 // caso nใo encontre altera็๕es do PE, mantem valor gravado no temporario.
				if  (VALOR - VALORENT)  > 0
					VALOR := VALOR - VALORENT
				Else
					DBDelete()
	...
	If (cArqDipam)->(msseek("25")) .and. (cArqDipam)->CODDIP=="25"
		While !((cArqDipam)->(Eof()))
			...
			If VALOR == 0 .and. (ascan(aDipamB25,{|x| x[1] == (cArqDipam)->CODDIP .and. x[2]==(cArqDipam)->MUNICIP}))  > 0
				lAchou25:= .T.
			Endif
			If lAchou25 // caso nใo encontre altera็๕es do PE, mantem valor gravado no temporario.
				RecLock(cArqDipam,.F.)
				VALOR:=1
				MsUnLock()
			Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao  ณa972CriaTempบAutor  ณAndreia dos Santos  ?Data ? 26/06/00   บฑ?
ฑฑฬออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.   ณCria todos os arquivos temporarios necessarios a geracao da   บฑ?
ฑฑ?       ณGIA                                                           บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso     ?MATA972                                                      บฑ?
ฑฑศออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
...
If !lRelDIPAM
	...
	//ณArquivo do Cabecalho do Doc.Fiscal CR=05?
	...
	//ณArquivo Detalhes interestaduais CR=14?
...
If !lRelDIPAM
	...
	//ณArquivo de IE_SUBSTITUTO CR=26?
	...
	//ณArquivo de IE_SUBSTITUIDO CR=27?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunctionณA972GeraTXT บAutor  ณMicrosiga           ?Data ? 07/03/00   บฑ?
ฑฑฬออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.   ณGera Arquivo texto para GIA                                   บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso     ณMATA972                                                       บฑ?
ฑฑศออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
...
While (cArqCabec)->(!eof())
	...
	While (cArqOcor)->(!eof())
		...
		Endif
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		//ณIES remetentes CR=25                                                                                           ?
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		...
		//ณCR=26 - IESubstituto                                                                                           ?
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		//Os registros desse tipo detalham informa็๕es lan็adas em um registro pai do tipo Ocorr๊ncias CR=20, que possua  ?
		//no campo C๓dSubItem, um dos seguintes valores: 00210 ou 00211 e campo Pr๓priaOuST=0.                            ?
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		If cRef > "200112"
		...
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		//ณCR=27 - IESubstituํdo                                                                                           ?
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		//Os registros desse tipo detalham informa็๕es lan็adas em um registro pai do tipo Ocorr๊ncias CR=20, que possua  ?
		//no campo C๓dSubItem, um dos seguintes valores: 00701 ou 00702 e campo Pr๓priaOuST=1.                            ?
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ?
		If cRef > "200112"
...
ฑฑบFunction  ณa972MestreบAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณArmazena informacoes no arquivo texto para armazenar infor- บฑ?
ฑฑ?         ณmacoes do registro mestre. CR=01                            บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?mata972                                                    บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบTamanho   ?32 Bytes                                                   บฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunction  ณa972Cabec บAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณCabecalho do documento fiscal.							  บฑ?
ฑฑ?         ณContem informacoes sobre o contribuinte e informacoes geraisบฑ?
ฑฑ?         ณsobre o documento fiscal. CR=05							  บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?Mata972                                                    บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบTamanho   ?127 Bytes                                                  บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
cRegistro   +=  a972Fill(REPLICATE("0",32),32)						//No caso em que o Pr?formatado-NG ?gerado por algum sistema de informa็ใo contแbil, deixar este campo com ZEROS
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunction  ณa972CFOP()บAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณDetalhes CFOPs.                                             บฑ?
ฑฑ?         ณContem lancamentos de valores totalizados por CFOPs.Cada re บฑ?
ฑฑ?         ณgistro do tipo Detalhes CFOPs pertence a um unico registro  บฑ?
ฑฑ?         ณdo tipo Cabecalho do Documento Fiscal. CR=10                บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?MATA972 										 	          บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบTamanho   ?119 bytes   								 	              บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษอออออออออัอออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunction ณa972EstadosบAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬอออออออออุอออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.    ณDetalhes Interestaduais.CR=14	                              บฑ?
ฑฑ?        ณContem informacoes relativas as entradas interestaduais e/ou บฑ?
ฑฑ?        ณsaidas interestaduais agrupadas por estados. Registros deste บฑ?
ฑฑ?        ณtipo irao existir sempre que existir registros Detalhes CFOPSบฑ?
ฑฑ?        ณcom valor do campo CFOP =2XX ou 6XX.                         บฑ?
ฑฑฬอออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso      ?AP5          	                                              บฑ?
ฑฑฬอออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบTamanho  ?131 Bytes 	                                              บฑ?
ฑฑศอออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษอออออออออัอออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunction ณA972ZFrancaบAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬอออออออออุอออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.    ณZFM/ALC. CR=18                                               บฑ?
ฑฑ?        ณNeste registro detalham-se as informacoes relativas as saidasบฑ?
ฑฑ?        ณinterestaduais, quando houver lancamentos de CFOPs do grupo  บฑ?
ฑฑ?        ?.XX e a operacao permitir o beneficio da isencao devido aos บฑ?
ฑฑ?        ณmunicipios destinos pertencentes a Zona Franca de Manaus ou  บฑ?
ฑฑ?        ณAreas de Livre Comercio. Nao possui registros filhos         บฑ?
ฑฑฬอออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso      ?AP5                                                         บฑ?
ฑฑฬอออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบTamanho  ?52 bytes	                                                  บฑ?
ฑฑศอออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออัออออออออออออออหอออออออัออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao  ณa972OcorrenciaบAutor  ณAndreia dos Santos?Data ? 20/06/00   บฑ?
ฑฑฬออออออออุออออออออออออออสอออออออฯออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.   ณOcorrencias. CR=20                                            บฑ?
ฑฑ?       ณDetalham informacoes correspondentes aos campos 052-Outros De-บฑ?
ฑฑ?       ณbitos, 053-Estorno de Cr้ditos, 057(Outros Cr้ditos),058(Estorบฑ?
ฑฑ?       ณno de Debitos),064-Deducoes(RPA/DISPENSADO) e 064-Outras(RES) บฑ?
ฑฑ?       ?necessแrias para Apuracao do ICMS para Operacoes Proprias e  บฑ?
ฑฑ?       ณApuracao do ICMS-ST-11              						  บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso     ?AP5                                                          บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบTamanho ?429 bytes.                                                   บฑ?
ฑฑศออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษอออออออออัออออออออออออออหอออออออัอออออออออออออออออออหออออออัออออออออออออปฑฑ
ฑฑบFunction ณa972RemetentesบAutor  ณAndreia dos Santos ?Data ? 20/06/00  บฑ?
ฑฑฬอออออออออุออออออออออออออสอออออออฯอออออออออออออออออออสออออออฯออออออออออออนฑฑ
ฑฑบDesc.    ณIEs Remetentes. CR=25										   บฑ?
ฑฑ?        ณOs registros desse tipo detalham informacoes lancadas em um   บฑ?
ฑฑ?        ณregistro-pai do tipo Ocorrencias cujo campo CodSubItem>=00704 บฑ?
ฑฑ?        ?e CodSubItem<=00707.                                         บฑ?
ฑฑฬอออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso      ?AP5          	                                               บฑ?
ฑฑฬอออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบTamanho  ?31 Bytes     	                                               บฑ?
ฑฑศอออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunction  ณa972FILL  บAutor  ณAndreia dos Santos  ?Data ? 19/06/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ?Encaixa conteudo no espaco especificado.                   บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?Mata972                                                    บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao    ณa972Grava บAutor  ณAndreia dos Santos  ?Data ? 26/06/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณGrava Registro no arquivo texto e acrescenta marca de final บฑ?
ฑฑ?         ณde registro                                                 บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?MATA972                                                    บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao  	 ณA972CodUF บAutor  ณAndreia dos Santos  ?Data ? 12/07/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณConverte as unidades de federacao para um codigo aceito no  บฑ?
ฑฑ?         ณprograma NOVA GIA da Secretaria da fazenda                  บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?mata972                                                    บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao    ณa972Dipam บAutor  ณAndreia dos Santos  ?Data ? 26/06/00   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณGrava os registros referentes a DIPAM-B. CR=30              บฑ?
ฑฑ?         ?                                                           บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?MATA972                                                    บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao    ณa972Expot บAutor  ณEduardo Jose Zanardo?Data ? 08/02/02   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณGrava os registros referentes a exportacao CR=31            บฑ?
ฑฑ?         ?                                                           บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ?MATA972                                                    บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao    ณa972TmpIE ?Autor ณSergio S. Fuzinaka  ?Data ? 26/05/03   บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณGrava os registros referentes a IE CR=25, somente movimenta-บฑ?
ฑฑ?         ณcao de transferencia ( F3->TRFICM > 0 )                     บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ณMATA972                                                     บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao    ณa972TmIeST ?Autor ณDiego Dias          ?Data ? 28/07/16  บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณGrava os registros referentes a IE Substituto CR=26         บฑ?
ฑฑ?         ?                                                           บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ณMATA972                                                     บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFuncao    ณa972TmIeSD ?Autor ณDiego Dias          ?Data ? 28/07/16  บฑ?
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.     ณGrava os registros referentes a IE Substituํdo CR=27        บฑ?
ฑฑ?         ?                                                           บฑ?
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso       ณMATA972                                                     บฑ?
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
ฑฑษออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑ?
ฑฑบFunctionณA972RetMun  บAutor  ณGustavo G. Rueda    ?Data ? 28/09/2004 บฑ?
ฑฑฬออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑ?
ฑฑบDesc.   ณVerifica se existe integracao com o TMS, e caso exista retornaบฑ?
ฑฑ?       ?o codigo do municipio da tabela DUE ou DUL. Caso contrario   บฑ?
ฑฑ?       ?retorno do cadastro de cliente posicionado anteriormente.    บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบParamet.ณExpC -> Indica o alias da tabela SF3 a ser utilizada.         บฑ?
ฑฑ?       ณExpL -> Integracao com o TMS.                                 บฑ?
ฑฑฬออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑ?
ฑฑบUso     ?MATA972                                                      บฑ?
ฑฑศออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑ?
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ?
...
If lTms
	...
	EndIf
EndIf
//Alterado para quando nใo houver integra็ใo com TMS, traga o c๓digo de municipio, para nใo apresentar erro na valida็ใo.
If Empty(cCod_Mun)
...
Funcao responsabel em existir a mensagem de obrigatoriedade de uso do TAF para gerar as obriga็๕es fiscais a partir de uma determinada data.
Ela utiliza um jpg desenvolvido por MKT ( banner_taf.jpg ).
Se existir compilado o resource de Banner (.jpg) no reposit๓rio, ele utiliza uma apresentacao mais elaborada. Pode acontecer do programa 
nใo estar no RPO, por isso faz um tratamento com getResArray.
...
If !( len( aRes ) > 0 )
	...
	cTxt	+=	'Sabemos que o cotidiano do profissional da แrea de tributos ?bastante dinโmico e exige um controle detalhado de todas as atividades que envolvem obriga็๕es fiscais.<br><br>'
	cTxt	+=	'Pensando nisso, a TOTVS desenvolveu o <b>TAF - TOTVS Automa็ใo Fiscal</b>, que ?uma solu็ใo especialista em consolida็ใo de informa็๕es e converg๊ncia fiscal.<br><br>'
	cTxt	+=	'Ao utilizar essa solu็ใo, voc?ganha <b>desempenho</b> na gera็ใo de obriga็๕es fiscais, <b>velocidade na implementa็ใo, suporte t้cnico personalizado e consultoria tributแria.</b><br><br>'
	cTxt	+=	'A partir de Fevereiro de 2017, algumas obriga็๕es fiscais na linha Microsiga Protheus passarใo a ser atendidas somente atrav้s do TAF.<br><br>'
EndIf

if !Empty( cTxt ) //quando o resoruce ( banner ) nใo estiver no rpo
	nLin	:=	470
else
	//foi necessแrio aumentar a tela de 520 para 570 e 420 para 470 devido a um problema de lib onde o botใo (X) que fecha a tela
	//nใo est?aparecendo na versใo 12. Ajustar ap๓s corre็ใo do fw.
	nLin	:=	570
endif

//foi necessแrio comentar o "nOr( WS_VISIBLE, WS_POPUP )" devido a um problema de lib onde o botใo (X) que fecha a tela do objeto FWLayer
//nใo est?aparecendo na versใo 12. Descomentar ap๓s corre็ใo do fw.
